...
See https://github.com/cortezaproject/corteza-protobuf[protobuf service definition] for details.
...
| Template to assemble base url for system, compose REST API (`CORREDOR_EXEC_CSERVERS_*\_API_BASEURL`).
