...
3+| CORREDOR_SCRIPTS_BASEDIR
| string
| `./usr`
| Base directory for user scripts

3+| CORREDOR_SCRIPTS_PACKAGE_JSON_FILE
| string
| `package.json`
|

3+| CORREDOR_SCRIPTS_NODE_MODULES_DIR
| string
| `./node_modules`
| By default Corredor uses it's own directory for user scripts

3+| CORREDOR_SCRIPTS_SERVER_BASEDIR
| bool
| scripts-basedir + +`./usr/server`
| Location of server scritps
...
3+| CORREDOR_SCRIPTS_CLIENT_BASEDIR
| bool
| scripts-basedir + +`./usr/client`
| Location of client scritps
